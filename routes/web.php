...
Route::group(['middleware' => 'auth'], function(){
	...
	Route::get('/user/get-list', [UserController::class,'getUserList']);
		...
		Route::post('/canteen/store', [CanteenController::class,'store'])->name('canteen');
		Route::get('/canteen/edit/{id}', [CanteenController::class,'edit'])->name('canteen.edt');
		Route::get('/canteen/update', [CanteenController::class,'update'])->name('canteen.edit');
		Route::get('/ingredient/add/{id}', [IngredientsController::class,'index'])->name('ingredient.add');
		Route::post('/ingredient/store', [IngredientsController::class,'store'])->name('ingredient.store');
		Route::get('/product/add/{id}', [ProductController::class,'index'])->name('product.add');
